...
func loadAlphabet() {
	...
	alphabet.append(Letter(english: "te", persian: "ته", isolated: "ت", initial: "تـ", medial: "ـتـ", final: "ـت", ipa: "t", transliteration: "ta"))
	...
	alphabet.append(Letter(english: "ẕâl", persian: "ذال", isolated: "ذ", initial: "ذ", medial: "ـذ", final: "ـذ", ipa: "z", transliteration: "z"))		// TODO: What's the difference???
	...
	alphabet.append(Letter(english: "že", persian: "ژه", isolated: "ژ", initial: "ژ", medial: "ـژ", final: "ـژ", ipa: "ʒ", transliteration: ""))
	...
	alphabet.append(Letter(english: "ṣäd", persian: "صاد", isolated: "ص", initial: "صـ", medial: "ـصـ", final: "ـص", ipa: "s", transliteration: ""))
	alphabet.append(Letter(english: "zâd", persian: "ضاد", isolated: "ض", initial: "ضـ", medial: "ـضـ", final: "ـض", ipa: "z", transliteration: ""))
	alphabet.append(Letter(english: "toy", persian: "طی، طا", isolated: "ط", initial: "طـ", medial: "ـطـ", final: "ـط", ipa: "t", transliteration: ""))
	alphabet.append(Letter(english: "ẓoy", persian: "ظی، ظا", isolated: "ظ", initial: "ظـ", medial: "ـظـ", final: "ـظ", ipa: "z", transliteration: ""))
	alphabet.append(Letter(english: "ayn", persian: "عین", isolated: "ع", initial: "عـ", medial: "ـعـ", final: "ـع", ipa: "æ", transliteration: "a"))
	alphabet.append(Letter(english: "ġayn", persian: "غین", isolated: "غ", initial: "غـ", medial: "ـغـ", final: "ـغ", ipa: "ɣ", transliteration: "g"))
	alphabet.append(Letter(english: "fe", persian: "فه", isolated: "ف", initial: "فـ", medial: "ـفـ", final: "ـف", ipa: "f", transliteration: "f"))
	alphabet.append(Letter(english: "q̈âf", persian: "قاف", isolated: "ق", initial: "قـ", medial: "ـقـ", final: "ـق", ipa: "ɣ", transliteration: "qa"))
	alphabet.append(Letter(english: "kâf", persian: "کاف", isolated: "ک", initial: "کـ", medial: "ـکـ", final: "ـک", ipa: "k", transliteration: "ka"))
	...
	alphabet.append(Letter(english: "mim", persian: "میم", isolated: "م", initial: "مـ", medial: "ـمـ", final: "ـم", ipa: "m", transliteration: "ma"))
	...
	alphabet.append(Letter(english: "hā-ye do-češm", persian: "هه", isolated: "ه", initial: "هـ", medial: "ـهـ", final: "ـه", ipa: "h", transliteration: "eh"))
	alphabet.append(Letter(english: "ya", persian: "یه", isolated: "ی", initial: "یـ", medial: "ـیـ", final: "ـی", ipa: "eː", transliteration: "ē"))
	alphabet.append(Letter(english: "hamzah", persian: "همزه", isolated: "ء", initial: "", medial: "", final: "", ipa: "ʔ", transliteration: ""))
	alphabet.append(Letter(english: "hamzah alef", persian: "همزه", isolated: "أ", initial: "أ", medial: "ـأ", final: "ـأ", ipa: "ʔ", transliteration: ""))
	...
	alphabet.append(Letter(english: "he ye", persian: "", isolated: "ۀ", initial: "", medial: "", final: "ـۀ", ipa: "eje", transliteration: ""))
	alphabet.append(Letter(english: "lām alef", persian: "", isolated: "لا", initial: "", medial: "", final: "ـلا", ipa: "lɒ", transliteration: ""))
}
...
func loadDictionary() -> Bool {
	...
	guard let url = Bundle.main.url(forResource: filename, withExtension: "json") else {
		...
		// TODO: Remove
		// When JSON loading fails use dummy data
